...
public class CustomerRefDataService {
    ...
    public AccountDTO getCustomerByName(@PathVariable String customerName ){
        return webClient.get().uri("/customer/"+customerName).retrieve().bodyToMono(AccountDTO.class).block();
    }
}
